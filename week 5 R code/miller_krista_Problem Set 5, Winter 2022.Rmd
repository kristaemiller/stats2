...
m1.vs.m2<- anova(Model.1, Model.2, test='LR')
m1.vs.m2
...
# Code to conduct a nested model test between Model 1 and Model 2 here
m2.vs.m3<- anova(Model.2, Model.3, test='LR')
m2.vs.m3
...
probs.logreg<- predict(Model.3, type = "response")
...
Now that you've constructed your confusion matrix, use it to compute the four indices of model fit that we discussed.
```{r}
