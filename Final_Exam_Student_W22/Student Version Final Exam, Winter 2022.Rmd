...
model.forward <- # Complete this line
...
model.backward <- # Complete this line
...
mspe.forward.valid <- # Complete this line
mspe.forward.valid 
...
mspe.backward.valid  <- # Complete this line
mspe.backward.valid 
...
mspe.ridge.valid <- # Complete this line
mspe.ridge.valid 
...
mspe.lasso.valid <- # Complete this line
mspe.lasso.valid 
...
Forward model mean squared prediction error:
Backward model mean squared prediction error: 
Ridge model mean squared prediction error: 
Lasso model mean squared prediction error: 
...
Your answer here (list the included predictors): 
...
y.test.pred <- # Complete this line
...
confusion.matrix <- # Complete this line
confusion.matrix
...
precision <- # Complete this line
precision

# Code to compute recall

recall <- # Complete this line
recall

# Code to compute F1 score

F1 = # Complete this line
F1
...
A) Fill in the values of your confusion matrix. Note that you should also have the confusion matrix displayed as part of the output from your code. 
    ...
    True positives (your answer here): 
    False positives (your answer here): 
    True negatives (your answer here): 
    False negatives (your answer here): 
...
Your answer here (higher or lower): 
...
Your answer here (exponential or Weibull): 
