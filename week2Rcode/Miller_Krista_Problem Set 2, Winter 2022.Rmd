...
ggplot(doughnuts.factorial, aes(x=flour_type_factor, y= sim_tot_fat)) + geom_boxplot()
ggplot(doughnuts.factorial, aes(x=fat_type_factor, y= sim_tot_fat)) + geom_boxplot()
...
levene.test(doughnuts.factorial$sim_tot_fat,doughnuts.factorial$fat_type)
levene.test(doughnuts.factorial$sim_tot_fat,doughnuts.factorial$flour_type)
# Be sure to display your quantitative assessment in your knitted document!
