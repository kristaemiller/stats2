...
glm.null<- glm(worse~1, data= dat.train)
all <- glm(worse ~ ., data=dat.train)

# Code for your forward selection goes here

forward.model <- step(glm.null, direction='forward', scope=formula(all), family= "binomial", trace=1)
